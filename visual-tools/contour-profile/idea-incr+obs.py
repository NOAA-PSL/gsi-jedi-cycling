...
if __name__== '__main__':
  debug = 1
  output = 1
  datadir = '/work2/noaa/gsienkf/weihuang/jedi/per_core_timing/build/fv3-jedi/test/Data'
  anlfile = '%s/analysis/letkf/gfs/mem000/xainc.20201215_000000z.nc4' %(datadir)
  obsfile  = '%s/obs/testinput_tier_1/sondes_obs_2020121500_m.nc4' %(datadir)
